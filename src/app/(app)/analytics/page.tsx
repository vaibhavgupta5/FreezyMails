...
export default async function AnalyticsPage() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      {stats.length === 0 ? (
        <div className="skeu-card flex flex-col items-center justify-center min-h-[300px] text-center space-y-4  -skeu-base border border-surface-200 dark:border-surface-700">
          <BarChart2
            size={64}
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="skeu-card  -skeu-base border border-surface-200 dark:border-surface-700">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="skeu-card -skeu-base border border-surface-200 dark:border-surface-700 lg:col-span-2">
              <DailyAreaChart />
            </Card>
            <Card className="skeu-card -skeu-base border border-surface-200 dark:border-surface-700">
              <FunnelChart />
