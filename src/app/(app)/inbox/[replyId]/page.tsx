...
export default function ReplyPage() {
  ...
  if (!reply)
    return <div className="p-8 text-surface-600">Reply not found.</div>;
  ...
  return (
    <div className="p-4 lg:p-8 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="skeu-card  -skeu-base">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="text-surface-900 dark:text-surface-50">
      ...
      <div className="flex flex-col space-y-6">
        <div className="skeu-card  -skeu-base">
          <h2 className="text-lg font-bold mb-2 text-surface-900 dark:text-surface-50">
            {reply.subject}
          </h2>
        ...
        {reply.type !== "SENT" && (
          <div className="skeu-card  -skeu-base flex flex-col">
            ...
            <textarea
              className="w-full mb-4 border border-surface-300 dark:border-surface-600 rounded p-3  -inner bg-white dark:bg-surface-800 focus:ring-ice-500 focus:border-ice-500 text-surface-900 dark:text-surface-50 min-h-[150px]"
              value={responseText}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <Button
                ...
                className="flex items-center gap-2 text-sm px-4 py-2 bg-ice-50 dark:bg-ice-900/40 text-ice-700 dark:text-ice-300 hover:bg-ice-100 dark:hover:bg-ice-800 transition-colors border border-ice-200 dark:border-ice-700 rounded  -sm w-full sm:w-auto justify-center"
              >
                ✨ Suggest AI Reply
              </Button>
            ...
            {reply.repliedAt && (
              <p className="text-xs text-surface-500 mt-4 text-right">
