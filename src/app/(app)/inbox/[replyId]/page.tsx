...
export default function ReplyPage() {
 ...
 <div className="p-4 bg-bg-subtle dark:bg-ice-900/20 text-ice-800 dark:text-ice-200 text-sm border border-ice-100 dark:border-ice-800 rounded">
 Note: Fetching the exact rendered template text will be available in
 future updates. AI suggestions will use general campaign context for
 now.
 </div>
 </div>
 </div>
 ...
 <div className="whitespace-pre-wrap text-text-primary dark:text-surface-200 border-t border-surface-100 dark:border-surface-800 pt-4">
 {reply.body}
 </div>
 </div>

 {reply.type !== "SENT" && (
 <div className="skeu-card -skeu-base flex flex-col">
 <h3 className="font-semibold mb-2 text-text-primary ">
 Draft Response
 </h3>
 <textarea
 className="w-full mb-4 border border-border-subtle dark:border-border-subtle rounded p-3 -inner bg-white focus:ring-ice-500 focus:border-ice-500 text-text-primary min-h-[150px]"
 value={responseText}
 ...
 className="flex items-center gap-2 text-sm px-4 py-2 bg-bg-subtle dark:bg-ice-900/40 text-ice-700 dark:text-ice-300 hover:bg-border-subtle dark:hover:bg-ice-800 transition-colors border border-border-subtle dark:border-ice-700 rounded -sm w-full sm:w-auto justify-center"
 >
 ✨ Suggest AI Reply
 </Button>
 ...
 >
 {reply.repliedAt ? "Send Again" : "Send Reply"}
 </Button>
 </div>
 {reply.repliedAt && (
