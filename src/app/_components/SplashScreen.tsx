...
export default function SplashScreen() {
 ...
 <AnimatePresence>
 <motion.div
 className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-none overflow-hidden bg-bg-subtle/90 backdrop-blur-md -[inset_0_0_200px_rgba(255,255,255,1)]"
 initial={{ opacity: 1 }}
 ...
 showIcon={false}
 textSize="text-6xl"
 textColor="text-text-primary tracking-tight"
 />
 </motion.div>
 </motion.div>
 </AnimatePresence>
