...
export default async function LandingPage() {
  ...
  return (
    <>
      <SplashScreen />
      <div className="min-h-[100dvh] bg-surface-200 text-surface-900 font-sans selection:bg-ice-300 selection:text-ice-900 relative overflow-hidden">
        ...
        <div
          className="absolute top-[10%] right-[-10%] w-[40rem] h-[40rem] bg-ice-500 rounded-full mix-blend-multiply filter blur-[120px] opacity-10 animate-pulse pointer-events-none z-0"
          style={{ animationDelay: "2s" }}
        ></div>

        {/* Navbar */}
        <nav className="relative z-20 flex justify-between items-center px-8 py-6 max-w-7xl mx-auto">
          <Logo textColor="text-surface-900 drop- -sm" />
        ...
        <main className="relative z-10 max-w-7xl mx-auto px-8 py-20 lg:py-24 flex flex-col items-center text-center">
          <div className="relative w-full flex justify-center">
            ...
            <h1 className="relative z-10 text-6xl md:text-8xl font-black tracking-tighter mb-8 max-w-5xl text-surface-900 leading-[1.05] drop- -sm">
          ...
          <div className="mt-24 w-full max-w-6xl skeu-card p-2 md:p-4 bg-surface-100 rounded-2xl transform md:rotate-1 hover:rotate-0 transition-transform duration-500  -[0_20px_50px_-12px_rgba(0,0,0,0.1)] hover: -[0_20px_50px_-12px_rgba(34,136,204,0.2)]">
            <div className="bg-surface-50 rounded-xl border border-surface-300  -skeu-inset aspect-[16/9] flex flex-col overflow-hidden relative">
        ...
        <section
          id="features"
          className="bg-surface-100 border-y border-surface-300 py-24  -skeu-inset"
        >
          <div className="max-w-7xl mx-auto px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="skeu-card flex flex-col items-start p-8 hover:-translate-y-1 transition-transform">
                <div className="w-12 h-12 rounded-lg bg-ice-100 text-ice-600 flex items-center justify-center mb-6  -skeu-inset border border-ice-200">
                  <Mail size={24} />
                </div>
              ...
              <div className="skeu-card flex flex-col items-start p-8 hover:-translate-y-1 transition-transform">
                <div className="w-12 h-12 rounded-lg bg-amber-100 text-amber-600 flex items-center justify-center mb-6  -skeu-inset border border-amber-200">
                  <Bot size={24} />
                </div>
              ...
              <div className="skeu-card flex flex-col items-start p-8 hover:-translate-y-1 transition-transform">
                <div className="w-12 h-12 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center mb-6  -skeu-inset border border-emerald-200">
                  <BarChart2 size={24} />
                </div>
        ...
        <footer className="border-t border-surface-400 py-12 text-center text-surface-600">
          ...
          <p className="text-sm flex items-center justify-center gap-1">
            ...
            <a
              ...
              className="font-medium hover:text-ice-600 transition-colors underline decoration-ice-300 decoration-2 underline-offset-2"
            >
              vaibhavgupta5
            </a>
          </p>
